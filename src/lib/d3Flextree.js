...
var d3_layout_flextree = () => {
    ...
    tree.separation = (x) => {
        if (arguments && !arguments.length) return separation;
        separation = x;
        spacing = null;
        return tree;
    };
    ...
    tree.spacing = (x) => {
        if (arguments && !arguments.length) return spacing;
        spacing = x;
        separation = null;
        return tree;
    }
    ...
    tree.size = (x) => {
        if (arguments && !arguments.length) return size;
        size = x;
        nodeSize = null;
        return tree;
    };
    ...
    tree.nodeSize = (x) => {
        if (arguments && !arguments.length) return nodeSize;
        nodeSize = x;
        size = null;
        return tree;
    };
    ...
    tree.setNodeSizes = (x) => {
        if (arguments && !arguments.length) return setNodeSizes;
        setNodeSizes = x;
        return tree;
    };
